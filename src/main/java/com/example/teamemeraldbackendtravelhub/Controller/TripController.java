...
public class TripController {
  ...
  public ResponseEntity<String> deleteActivity(@PathVariable("id") String id, @RequestBody Activity activity) {
    try {
      return new ResponseEntity<>(tripService.deleteActivity(id, activity), HttpStatus.OK);
    } catch (Exception e) {
      return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
    }
  }
